# Magento 2 Resources [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](CONTRIBUTING.md) [![860 resources](https://img.shields.io/badge/resources-860-orange.svg?style=flat)](#table-of-contents) [![Links Health Status](https://github.com/aleron75/mageres/actions/workflows/check-links-health.yml/badge.svg)](https://github.com/aleron75/mageres/actions?query=workflow%3A%22Check+Links+Health%22)
...
* [Create Project](https://github.com/GrimLink/create-project) - A small CLI scaffolding tool that helps you spin up new projects for popular web platforms from your terminal.
...
* [fast-di-compile (Rust Magento DI Compiler)](https://github.com/speedupmate/di-compiler) - A faster DI compiler written in Rust that should bring a 10x performance improvement.
...
* [go-m2rest](https://github.com/florinel-chis/go-m2rest) - A Golang library providing a comprehensive interface for interacting with the Magento 2 REST API. It features a context-aware read/sync API, structured logging, hardened retries, and an offline unit test suite.
...
* [Mage-OS Installer](https://github.com/mage-os-lab/mage-os-installer) - Get up & running with Mage-OS in minutes. If you have DDEV or Warden installed already, this tool will automatically detect and configure them for you.
* [mage-remote-run](https://github.com/muench-dev/mage-remote-run) - The remote swiss army knife for Magento Open Source, Mage-OS, Adobe Commerce.
...
* [Magento / Mage-OS / Adobe Commerce perfomance scanner](https://github.com/qoliber/mage-scan.com) - Qoliber's Mage Scan Mage is a performance scanner for Magento, Mage-OS, and Adobe Commerce websites. It identifies common implementation issues to help store owners, freelancers, and agencies maintain smooth operations.
...
* [Magento 2 MCP Server](https://github.com/boldcommerce/magento2-mcp) - A Model Context Protocol (MCP) server that connects to a Magento 2 REST API, allowing Claude and other MCP clients to query product information from a Magento store.
...
* [Magento 2 Snippets for Zed](https://github.com/mage-os-lab/zed-magento2-snippets) - Magento 2 and Hyvä snippets for the Zed editor that cover the boilerplate you write every day, from phtml headers and CSP script tags to layout XML, di.xml, and system.xml.
...
* [Magento Bricklayer](https://github.com/Inchoo/magento-bricklayer) - An MCP server that provides AI coding agents with runtime visibility into Magento 2, enabling them to make informed architectural decisions rather than guessing.
...
* [Magento CMS Sync](https://github.com/florinel-chis/magento2-cms-sync) - A powerful web-based tool for synchronizing CMS content (blocks and pages) between multiple Magento 2 instances. Built with FastAPI (Python) backend and React (TypeScript) frontend.
...
* [PhpStorm Booster](https://github.com/qoliber/phpstorm-booster) - A PhpStorm/IntelliJ plugin with tools for better local development practices — focused on taming indexing and cache bloat on large PHP/Magento projects.
...
* [PolyShell Protection Module](https://github.com/aregowe/magento2-module-polyshell-protection) - Comprehensive defense-in-depth module that closes the PolyShell unrestricted file upload vulnerability (APSB25-94) in Adobe Commerce. PolyShell affects all Magento Open Source and Adobe Commerce versions up to 2.4.9-alpha2. No official isolated patch exists for production versions.
...
* [Advanced Validator](https://github.com/piotrwx/advanced-validator) - The Advanced Validator module for Magento 2 allows you to implement custom validation rules for checkout fields. You can use regular expressions to validate fields like city, postcode, and more during the checkout process.
...
* [Agentic Commerce Protocol for Magento 2](https://github.com/run-as-root/ACP-for-Magento-2) - This is a Magento 2 extension that enables ChatGPT purchases directly from your store using the Agentic Commerce Protocol (ACP). This open standard allows conversations between buyers, their AI agents, and businesses to complete purchases.
* [Ai Dashboard](https://github.com/gabrielgts/module-ai-dashboard) - AI-powered analytics dashboard for Magento 2. Replaces the stock admin dashboard with KPI cards, charts, and an embedded store assistant. All built from data computed on cron and served from cache.
...
* [Bold Commerce - Magento 2 Model Time Machine](https://github.com/boldcommerce/magento2-model-timemachine) - This module tracks changes on models and logs these changes to a database table.
...
* [Brand extension for Magento 2](https://github.com/boolfly/brand) - A Brand extension that allows you to manage and display brands. You can customise settings, such as enabling brand display, managing brand details, and configuring how brands appear on product pages.
...
* [Corrivate Composer Dashboard](https://github.com/LBannenberg/magento2-composer-dashboard) - Admin grids that allow merchants and PMs to view installed composer packages, available updates, and security audits. Also provides reminder emails and API endpoints.
* [Coupon Error Message](https://github.com/ambab-infotech/coupon-error-message) - A Magento 2 extension that shows specific error messages when a coupon fails, instead of the generic “Coupon code is not valid.”
...
* [Elgentos Regenerate Catalog URLs](https://github.com/elgentos/magento2-regenerate-catalog-urls) - Set of console commands to regenerate catalog URLs.
...
* [Gift Sales Rule](https://github.com/Smile-SA/magento2-module-gift-sales-rule) - This module provides 2 new actions to Magento cart price rule feature to: offer gift product(s) to customer based on native conditions, or offer gift product(s) each time a threshold is reached.
...
* [Hryvinskyi Email Template Editor for Magento 2](https://github.com/hryvinskyi/magento2-email-template-editor) - A professional, feature-rich email template editor for Magento 2 that replaces the default email template management with a modern, real-time editing experience.
...
* [Inchoo SEO Manager](https://github.com/Inchoo/seo-manager/) - A powerful Magento 2 extension that incorporates a wide range of SEO tools designed to enhance your website’s search engine optimization.
...
* [Magento 2 Composer Dashboard](https://github.com/LBannenberg/magento2-composer-dashboard) - Provides a dashboard within the Magento admin to view installed packages and determine whether they need to be updated. Additionally, it allows you to configure daily/weekly email reminders for package status updates.
...
* [Magento 2 Configurator](https://github.com/ctidigital/magento2-configurator) - A Magento module for creating and maintaining database variables from files. It allows you to share and collaborate on versioned configurations and split them by environment.
...
* [Magento 2 Delete Orders extension Free](https://github.com/mageplaza/magento-2-delete-orders) - Helps admins completely remove unnecessary orders, invoices, shipments and credit memos which are arised during testing process. This helps simplify order management and get these arranged neater.
...
* [Magento 2 Indexer Isolation](https://github.com/furan917/Magento2-IndexerIsolation) - Moves slow Magento indexers into their own cron group so they stop blocking everything else.
...
* [Magento 2 MageAI Extension](https://github.com/mageprince/magento2-mage-ai) - Magento 2 extension to generate product short/long descriptions and product images with OpenAI (ChatGPT), Anthropic (Claude) & Google Gemini. Customizable prompts, multiple models, and clean HTML output.
...
* [Magento 2 Product Data Sync](https://github.com/falconmedia/magento2-product-data-sync) - A module for safely synchronising product data between products with support for multi-store configurations, attribute filtering, and comprehensive logging.
...
* [Magento 2 Selective Cache](https://github.com/mcspronko/selective-cache) - This extension adds a Refresh Invalidated Cache button. Upon clicking the button, the extension clears all cache types marked as Invali_d_. You can also configure and run a cron job to refresh invalidated Cache Types.
...
* [Magento 2 Subscription Module](https://github.com/digitalrisedorset/magento-subscription-module) - A module to enable subscription-based products with custom recurrence plans and server-side recurring order generation through secure Braintree transactions.
...
* [Offers Page](https://github.com/Ribog-Digital/magento2-module-offers-page) - Offers Page extension for Magento 2 provides a centralized and automated way to showcase all current catalog and cart price rules on a dedicated frontend page.
...
* [Orangecat B2B Suite](https://github.com/olivertar/m2_b2bsdk) - A comprehensive B2B suite providing company accounts, custom pricing, credit payments, purchase approvals, quick ordering, RMAs, sales reps, and customer-specific catalog, shipping, and payment rules.
...
* [ReachDigital Auto Invoice](https://github.com/ho-nl/magento2-ReachDigital_AutoInvoice) - This module auto-invoices orders and moves them to the processing state/status. It can be configured via DI to limit auto-invoicing only for specific payment methods.
...
* [Siteation - Magento 2 Pagespeed](https://github.com/Siteation/magento2-pagespeed) - An extension that helps optimise Magento 2 stores for better Google PageSpeed performance. It provides tools and configurations to improve Core Web Vitals by optimising asset loading, caching, and frontend delivery.
...
* [Siteation_DebugBar](https://github.com/Siteation/magento2-debugbar) - A debug bar for Magento 2 built for developers and coding agents.
...
* [Hyvä Algolia Search](https://github.com/blackbird-agency/hyva-algolia-search) - This extension integrates Algolia’s powerful search capabilities into Magento 2 stores using the Hyvä frontend.
...
* [Siteation - Hyvä CMS Product Grid](https://github.com/Siteation/hyva-cms-product-grid) - A Hyvä CMS module that offers an easy-to-use component for displaying product grids directly within your storefront's CMS pages and blocks. Requires a Hyvä Commerce license.
...
* [LLM.txt for Magento 2 / Mage-OS](https://github.com/mage-os-lab/llms.txt) - Automatically generate optimized llms.txt files for stores, helping AI systems to better understand the site's content. It features AI-powered content selection, one-click generation, and multi-store support while ensuring compliance with relevant standards.
* [Mage-OS Admin Activity Log](https://github.com/mage-os-lab/module-admin-activity-log) - A comprehensive admin activity logging extension for Mage-OS and Magento 2 that provides complete audit trails for administrative actions, login attempts, and page visits.
...
* [MageOS Admin User Time Zone Module for Magento 2](https://github.com/mage-os-lab/module-admin-user-time-zone) - Per-user timezone support for Magento 2 Admin Panel.
...
* [MageOS Blog](https://github.com/mage-os-lab/module-blog) - A blog module for Mage-OS and Magento 2. Posts, categories, tags, authors, scheduled publishing, RSS, sitemap, 6 storefront widgets, SEO (meta tags, Open Graph, Twitter Cards, JSON-LD), and a full GraphQL API. Works with Luma and Hyvä themes.
...
* [EcomDev’s Essentials for testing Magento 2 modules](https://github.com/EcomDev/magento2-test-essentials) - This library by EcomDev provides fake objects and an ObjectManagerInterface implementation to facilitate the testing of Magento 2 modules. Reducing reliance on mocking frameworks helps create more stable and maintainable test suites.
* [EcomDev’s Test Containers for Quick Magento Development](https://github.com/EcomDev/testcontainer-magento-data-php) - This library by EcomDev is designed to facilitate rapid integration testing for Magento applications. It provides pre-configured Docker containers populated with Magento databases and search engine configurations, enabling developers to set up and tear down testing environments quickly. This approach streamlines the testing process, allowing efficient and consistent testing workflows.
...
* [Elgentos Magento 2 Playwright](https://github.com/elgentos/magento2-playwright) - An open-source End-to-End testing suite built with Playwright to facilitate comprehensive testing of Magento storefronts, enhancing code reliability and reducing manual testing efforts.
...
* [Automatically create Magento's csp_whitelist.xml file](https://www.linkedin.com/pulse/automatically-create-magentos-cspwhitelistxml-file-kieckbusch-stlqc/) - Henrique Kieckbusch's recipe will help you easily create Magento's csp_whitelist.xml.
...
* [mage-mirror](https://github.com/j-scriptz/mage-mirror) - A high-speed Magento development environment generator built for Warden, Docker, and Hyvä.
...
* [Magento 2 Devcontainer](https://github.com/graycoreio/magento2-devcontainer) - Run Magento 2 locally with VS Code or instantly in GitHub Codespaces
