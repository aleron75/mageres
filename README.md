...
<p style="background-color:lightyellow; padding:1em; border:1px orange dashed;">If you want to **stay up to date with changes**, you can [subscribe to the monthly digest](https://mailchi.mp/6a498018d9ef/mageres).</p>
